# Spec: Player Entity Update

## Purpose

Defines how players modify their own entity's HP and conditions during combat, including authorization rules, HP clamping, fog-of-war rendering, and the initiative tracker display.
