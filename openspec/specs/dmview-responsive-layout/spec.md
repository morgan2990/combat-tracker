# Spec: DMView Responsive Layout

## Capability

dmview-responsive-layout

## Purpose

Defines how DMView adapts its layout across phone, tablet, and desktop viewport widths — determining tiers purely from viewport width, and progressively introducing a persistent DM Nav column and a persistent Statblock column as width increases, while keeping the phone tier's existing single-column layout unchanged.
