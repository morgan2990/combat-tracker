# Spec: Party Management

## Purpose

Defines Parties — cross-user groupings of member PCs with a pooled currency purse — and the Dashboard UI used to create parties, manage membership, and edit pooled currency.
