# Spec: Room Membership

## Purpose

Defines how the system tracks which rooms a user has joined as a player, purely as a recency record surfaced on the dashboard as "recent rooms" — it grants no permission.
