# Spec: DM Entity Override

## Purpose

Defines how the DM edits any entity's stats without ownership restrictions, including the smart HP input parsing that happens client-side before sending.
